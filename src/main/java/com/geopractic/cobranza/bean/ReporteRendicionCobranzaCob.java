...
/**
 * Bean de generacion de reporte de rendicion de Cobranza por cobrador.
 * @author Cristhian
 */
@ManagedBean (name = "rptRendicionCobranzaCob")
@ViewScoped
public class ReporteRendicionCobranzaCob extends BeanReportes implements Serializable {

  private static final long serialVersionUID = -8202410257686619696L;
   ...
   */
  public ReporteRendicionCobranzaCob() {
  ...
  public void generarParametros() {
    ...
    parametros.put("COBRADOR", empleado.getId());
   ...
   * de un cobrador.
   */
  public void generarReporteRendicionCobranzaCob() {
    ContenidoMultimedia contenido = generateReporte("rendicionCobranzaCobrador",
          "rendicionCobranzaCobrador.pdf");
  ...
  } //Fin del generarReporteRendicionCobranzaCob

} //Fin de la clase ReporteRendicionCobranzaCob